...
public class ClientIdVerifierAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "client-id-verifier";
    public static final String USER_ATTRIBUTE_NAME_CONFIG = "userAttributeName";
    public static final String USER_ATTRIBUTE_NAME_DEFAULT = "vidis_client_id";

    @Override
    public String getDisplayType() {
        return "Origin client ID verifier";
    }
    ...
    public String getHelpText() {
        return "Post-login authenticator that verifies the client ID echoed back by the IdP (stored in a user attribute) "
                + "matches the client ID originally sent to the IdP (stored in the authentication session). "
    ...
    public List<ProviderConfigProperty> getConfigProperties() {
        return ProviderConfigurationBuilder.create()
                ...
                .helpText("Name of the user attribute that holds the client ID returned by the IdP (e.g. mapped via a protocol mapper).")
    ...
    public Authenticator create(KeycloakSession session) {
        return new ClientIdVerifierAuthenticator();
    }
