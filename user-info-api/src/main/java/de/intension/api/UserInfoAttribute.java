...
public enum UserInfoAttribute
{
    ...
    PERSON_KONTEXT_ORG_ANSCHRIFT_PLZ(UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_PLZ, UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_PLZ,
            Boolean.TRUE, null, "Postleitzahl der Organisation"),
    PERSON_KONTEXT_ORG_ANSCHRIFT_ORT(UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_ORT, UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_ORT,
            Boolean.TRUE, null, "Amtlicher Gemeindename der Organisation"),
    PERSON_KONTEXT_ORG_ANSCHRIFT_ORTSTEIL(UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_ORTSTEIL,
            UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_ORTSTEIL, Boolean.TRUE, null, "Ortsteil der Organisation"),
    PERSON_KONTEXT_ORG_ANSCHRIFT_BUNDESLAND(UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_BUNDESLAND,
            UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_BUNDESLAND, Boolean.TRUE, null, "Bundesland der Organisation im Format ISO 3166-2:DE"),
    ...
    PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_PLZ(UserInfoAttributeNames.PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_PLZ,
            UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_PLZ, Boolean.TRUE, null, null),
    PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_ORT(UserInfoAttributeNames.PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_ORT,
            UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_ORT, Boolean.TRUE, null, null),
    PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_ORTSTEIL(UserInfoAttributeNames.PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_ORTSTEIL,
            UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_ORTSTEIL, Boolean.TRUE, null, null),
    PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_BUNDESLAND(UserInfoAttributeNames.PERSON_KONTEXT_ARRAY_ORG_ANSCHRIFT_BUNDESLAND,
            UserInfoAttributeNames.PERSON_KONTEXT_ORG_ANSCHRIFT_BUNDESLAND, Boolean.TRUE, null, null),
