...
/**
 * Interface to "adopt" the {@link org.keycloak.protocol.oidc.mappers.AbstractPairwiseSubMapper} behaviour.
 * Should make it easier to identify code changes after a new Keycloak release.
 */
public interface IPairwiseSubMapper extends OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {
     ...
     * By default, a pairwise sub mapper will only contain configuration for a sector identifier URI.
     */
     ...
     * This method is inspired by {@link org.keycloak.protocol.oidc.utils.PairwiseSubMapperValidator#validate(KeycloakSession, ClientModel, ProtocolMapperModel)}
     */
    void validateSectorIdentifier(KeycloakSession session, ClientModel client, ProtocolMapperModel mapperModel) throws ProtocolMapperConfigException;
}
